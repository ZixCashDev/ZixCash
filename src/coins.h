...
/** 
    ...
    ****Note - for ZIX we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of zixcash coming in to a transaction
