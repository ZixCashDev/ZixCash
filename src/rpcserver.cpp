...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"zixcash", "masternodelist", &masternodelist, true, true, false},
        {"zixcash", "mnbudget", &mnbudget, true, true, false},
        {"zixcash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
...
#ifdef ENABLE_WALLET
        {"zixcash", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
