...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ZIX Core zixcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zixcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zixcash transaction") + "\n" +
                               "  zixcash-tx [options] -create [commands]   " + _("Create hex-encoded zixcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zixcash transaction
