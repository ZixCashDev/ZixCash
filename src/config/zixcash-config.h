/* src/config/zixcash-config.h.  Generated from zixcash-config.h.in by configure.  */
/* src/config/zixcash-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.zixcashs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ZIX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ZIX Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zixcash"
