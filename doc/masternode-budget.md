...
ZIX now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<zixcash_address\> \<monthly_payment_zixcash\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ ZIX, _12_ times over the course of a year totaling _24000_ ZIX.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<zixcash_address\> \<monthly_payment_zixcash\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` ZIX.
 ...
 * vote-many          - Vote on a ZIX initiative
 * vote-alias         - Vote on a ZIX initiative
 * vote               - Vote on a ZIX initiative/budget
